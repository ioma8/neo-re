...
export function ConnectionScreen({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_30%_15%,#eaf1ff_0,#faf8ff_36%,#f7f9ff_100%)] p-md text-on-surface md:p-margin">
